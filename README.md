...
- **Comprehensive Evaluation**: Includes confusion matrices, accuracy metrics, and loss tracking
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/sahas025/cnn-for-brain-tumor.git
   cd cnn-for-brain-tumor
